# TOOLS.md — every OSS tool registered for StayNest

This file is the single inventory of every OSS tool wired up for StayNest.
...
| networking | [maplibre](networking/maplibre/) | `networking/maplibre/` (scaffold) |
...
| domain-oss | [openigc](domain-oss/openigc/) | `domain-oss/openigc/` (deployable) |
