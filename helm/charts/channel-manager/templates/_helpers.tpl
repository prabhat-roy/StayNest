{{- define "channel-manager.name" -}}{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}{{- end -}}
...
{{- if .Values.serviceAccount.create -}}{{- include "channel-manager.fullname" . -}}
